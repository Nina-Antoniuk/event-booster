...
export class Select {
    ...
    open() {
        ...
        this.arrow.removeAttribute("href", "./images/svg/sprits.svg#icon-select-down")
        this.arrow.setAttribute("href", "./images/svg/sprits.svg#icon-select-up")
    }

    close() {
        this.elem.classList.remove('open')
        this.arrow.removeAttribute("href", "./images/svg/sprits.svg#icon-select-up")
        this.arrow.setAttribute("href", "./images/svg/sprits.svg#icon-select-down")
    }
